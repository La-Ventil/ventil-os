import { MachineAvailability } from '@repo/application/machines/models/machine';
...
const machines: MachineViewModel[] = [
  {
    ...
    category: 'Categorie',
    name: 'Machine 1',
    description: "La machine permet d'imprimer par dépôt de fil polymère fondu des pièces en 3D.",

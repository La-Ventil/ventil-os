...
const openBadgeBaseObject = z.object({
...
export const openBadgeCreateFormSchema = zfd.formData(openBadgeBaseObject);
export const openBadgeCreateFieldsSchema = zfd.formData(openBadgeBaseObject.omit({ imageUrl: true }));

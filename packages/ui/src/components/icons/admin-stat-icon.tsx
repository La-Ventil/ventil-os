...
function AdminStatIconSvg(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 55 55" {...props}>
      ...
      <path
        fill="currentColor"
        d="M23,38.5h-6v-16l10.5-6,10.5,6v4.5c0,.55.45,1,1,1h0c.55,0,1-.45,1-1v-4.5c0-.72-.38-1.38-1.01-1.74l-10.5-6c-.31-.18-.65-.26-.99-.26s-.68.09-.99.26l-10.5,6c-.62.36-1.01,1.02-1.01,1.74v16c0,1.1.9,2,2,2h6c.55,0,1-.45,1-1h0c0-.55-.45-1-1-1Z"
      />
    </svg>
  );
}

...
function AvatarNoseIconSvg(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" {...props}>
      <path
        fill="currentColor"
        d="M20.22,23.05l-1.49-.75,1.69-2.53c.15-.23.09-.54-.14-.69-.23-.15-.54-.09-.69.14l-2,3c-.08.12-.1.27-.07.41s.13.25.26.32l2,1c.07.04.15.05.22.05.18,0,.36-.1.45-.28.12-.25.02-.55-.22-.67Z"
      />
      <path
        fill="currentColor"

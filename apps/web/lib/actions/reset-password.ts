...
import {ResetPasswordFormData, resetPasswordFormDataSchema} from "../models/signin-form-data";
...
export async function resetPassword(previousState, formData: FormData) {
    ...
    `;
        ...
        return {
            message: 'Si votre email existe dans notre base de donnée, un email permettant de changer de mot de passe vous a été envoyé.',
            isValid: true,
            fieldErrors: [],
        };
    } catch (e) {
